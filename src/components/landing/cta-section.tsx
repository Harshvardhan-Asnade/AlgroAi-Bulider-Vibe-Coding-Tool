    ...
    return (
        <section className="w-full py-20 lg:py-32 relative">
            ...
            <div className="container mx-auto px-4 text-center relative z-10">
                <h2 className="text-3xl md:text-4xl font-bold font-headline">Join the future of coding</h2>
                <p className="mt-4 max-w-2xl mx-auto text-muted-foreground">
                    Be part of the revolution with AlgroAI.build and start creating at the speed of light.
                </p>
                <div className="mt-8">
